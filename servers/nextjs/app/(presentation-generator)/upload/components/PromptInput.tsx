    ...
    <div className="space-y-2">
      <div className="relative">
        <Textarea
          ...
          placeholder="Расскажите о вашей презентации"
      ...
      >
        Укажите конкретные детали о ваших потребностях в презентации (например, тема, стиль, ключевые моменты) для более точных результатов
      </p>
    </div>
  );
}
