# ИНТЕКЛАСС х СТАРТАП-СТУДИЯ УНИВЕРСИТЕТОВ ТОМСКА, команда ООО "Стартапчик"
## Структура проекта
```
. 
├── auth/          # Код сервиса авторизации
├── images/        # Скриншоты и примеры интерфейса
├── presentone/    # Исходный код проекта-основы
└── README.md      # Главный файл с описанием проекта
```

## Архитектура проекта 
<img src="images/архитектура.png" alt="Скриншот" width="640" height="1080">
## 🎯 Идея
